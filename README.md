...
This project is a code challenge for Finalis. It is a server that provides a REST API for a simple CRUD application using [Nest](https://github.com/nestjs/nest) framework TypeScript starter repository.
